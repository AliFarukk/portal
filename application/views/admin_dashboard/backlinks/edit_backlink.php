			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="d-flex flex-column pt-5 justify-content-center align-items-center">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form class="p-4 col-lg-6 col-sm-12" action="<?= BASE_URL . 'backlink/update/' . $backlink->backlink_id; ?>" method="post">
							...
							<div class="form-group w-sm-100 w-lg-50">
								...
								<input required type="url" value="<?= $backlink->domain; ?>" name="domain" class="input-bg form-control" placeholder="Domain">
							</div>

							<div class="form-group w-sm-100 w-lg-50">
								<label for="exampleInputEmail1">Link</label>
								<input required type="url" value="<?= $backlink->link; ?>" name="link" class="input-bg form-control" placeholder="Url">
